...
const Header: FC<HeaderProps> = ({ name, image, children }) => {
  return (
    <header className="bg-color_1 p-7 md:p-10 md:py-5 lg:flex lg:items-center lg:border-b-0 lg:bg-color_3 2xl:p-16 2xl:py-7">
      ...
      <h1 className="text-outline text-center font-play text-4xl uppercase text-white lg:text-left xl:text-6xl">
        {name}
      </h1>
      {children && children}
    </header>
