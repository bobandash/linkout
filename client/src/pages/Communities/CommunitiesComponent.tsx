...
const CommunitiesComponent = () => {
  return (
    <div className="flex-grow bg-primary p-5">
      <div>
        <div className="mx-auto rounded-lg border-2 bg-secondary p-5">
        ...
        <h1 className="text-outline mt-5 font-fingerPaint text-2xl text-white md:text-3xl xl:text-4xl">
          Biggest Communities
        </h1>
        <div className="flex-row flex-wrap md:flex md:gap-3 lg:gap-5">
          <CommunityCard />
          <CommunityCard />
          <CommunityCard />
        </div>
