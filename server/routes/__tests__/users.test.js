...
describe('POST /users/create', () => {
  it('works with valid form data', async () => {
  ...
  it(`doesn't work when user already exists`, async () => {
    ...
    expect(response.body).toEqual({
      email: { msg: 'Email already has an account' },
    });
  });

  it(`doesn't work when confirm password doesn't match`, async () => {
    const response = await request(app)
      .post('/users/create')
      .type('form')
      .send({
  ...
  it(`doesn't work when password & email aren't valid`, async () => {
    const response = await request(app)
      .post('/users/create')
      .type('form')
      .send({
